declare global {
  const R2StorageService: typeof import('../../server/utils/r2').R2StorageService
  const __buildAssetsURL: typeof import('../../../node_modules/.pnpm/@nuxt+nitro-server@4.2.2_db0@0.3.4_ioredis@5.9.2_magicast@0.5.2_nuxt@4.2.2_@biomejs+biome@2.3_dbnjtlatgyd7xf66uanqesuhbm/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths').buildAssetsURL
  const __publicAssetsURL: typeof import('../../../node_modules/.pnpm/@nuxt+nitro-server@4.2.2_db0@0.3.4_ioredis@5.9.2_magicast@0.5.2_nuxt@4.2.2_@biomejs+biome@2.3_dbnjtlatgyd7xf66uanqesuhbm/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths').publicAssetsURL
  ...
  const config: typeof import('../../server/utils/config').config
  ...
  const deepgramToCombo: typeof import('../../server/utils/transcribe/deepgram-to-combo').deepgramToCombo
  const defaultContentType: typeof import('../../../node_modules/.pnpm/h3@1.15.5/node_modules/h3').defaultContentType
  const defineAppConfig: typeof import('../../../node_modules/.pnpm/@nuxt+nitro-server@4.2.2_db0@0.3.4_ioredis@5.9.2_magicast@0.5.2_nuxt@4.2.2_@biomejs+biome@2.3_dbnjtlatgyd7xf66uanqesuhbm/node_modules/@nuxt/nitro-server/dist/runtime/utils/config').defineAppConfig
  ...
  const detectLanguage: typeof import('../../server/utils/transcribe/detect-language').detectLanguage
  ...
  const languageCodeToName: typeof import('../../server/utils/transcribe/detect-language').languageCodeToName
  ...
  const transcribe: typeof import('../../server/utils/transcribe/index').transcribe
...
declare global {
  // @ts-ignore
  export type { R2StorageService, PresignedUpload } from '../../server/utils/r2'
  import('../../server/utils/r2')
  // @ts-ignore
  export type { Transcript, TranscriptObject, Word, LanguageDetectionResults, LanguageDetectionResultsEntry, Sentence, Paragraph } from '../../server/utils/transcribe/types'
  import('../../server/utils/transcribe/types')
  // @ts-ignore
  export type { TranscribeOptions } from '../../server/utils/transcribe/index'
  import('../../server/utils/transcribe/index')
}
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/Users/dev/Repos/openvideo/openvideo/node_modules/.pnpm/@nuxt+nitro-server@4.2.2_db0@0.3.4_ioredis@5.9.2_magicast@0.5.2_nuxt@4.2.2_@biomejs+biome@2.3_dbnjtlatgyd7xf66uanqesuhbm/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/Users/dev/Repos/openvideo/openvideo/node_modules/.pnpm/@nuxt+nitro-server@4.2.2_db0@0.3.4_ioredis@5.9.2_magicast@0.5.2_nuxt@4.2.2_@biomejs+biome@2.3_dbnjtlatgyd7xf66uanqesuhbm/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { config } from '/Users/dev/Repos/openvideo/openvideo/vue-video-editor/server/utils/config';
export { R2StorageService } from '/Users/dev/Repos/openvideo/openvideo/vue-video-editor/server/utils/r2';
export { deepgramToCombo } from '/Users/dev/Repos/openvideo/openvideo/vue-video-editor/server/utils/transcribe/deepgram-to-combo';
export { detectLanguage, languageCodeToName } from '/Users/dev/Repos/openvideo/openvideo/vue-video-editor/server/utils/transcribe/detect-language';
export { transcribe } from '/Users/dev/Repos/openvideo/openvideo/vue-video-editor/server/utils/transcribe/index';