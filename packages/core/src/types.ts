...
export interface ITransitionClip extends IBaseClip { type: "Transition"; }

export type AnyClip = IVideoClip | IAudioClip | IImageClip | ITextClip | ICaptionClip | ITransitionClip;
