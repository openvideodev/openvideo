...
export const ROTATION_MOVEMENT_UNIFORMS: Record<string, { value: any; type: string }> = {
...
export const RED_GRADIENT_UNIFORMS: Record<string, { value: any; type: string }> = {
...
export const BUBBLE_SPARKLES_UNIFORMS: Record<string, { value: any; type: string }> = {
  uTime: { value: 0.0, type: "f32" },
...
export const UV_GRADIENT_UNIFORMS: Record<string, { value: any; type: string }> = {
...
export const HEART_SPARKLES_UNIFORMS: Record<string, { value: any; type: string }> = {
  uTime: { value: 0.0, type: "f32" },
...
export const BUTTERFLY_SPARKLES_UNIFORMS: Record<string, { value: any; type: string }> = {
  uTime: { value: 0.0, type: "f32" },
...
export const FADE_IN_UNIFORMS: Record<string, { value: any; type: string }> = {
  uTime: { value: 0.0, type: "f32" },
  uDuration: { value: 1.0, type: "f32" },
};

export const FADE_OUT_FRAGMENT = `
in vec2 vTextureCoord;
...
export const FADE_OUT_UNIFORMS: Record<string, { value: any; type: string }> = {
  uTime: { value: 0.0, type: "f32" },
  uDuration: { value: 1.0, type: "f32" },
};
