        ...
        <div className="grid grid-cols-2 gap-2">
          <InputGroup>
            ...
            <InputGroupInput
              ...
              onChange={(e) => updateOne({ transform: { x: parseInt(e.target.value) || 0 } })}
          ...
          <InputGroup>
            ...
            <InputGroupInput
              ...
              onChange={(e) => updateOne({ transform: { y: parseInt(e.target.value) || 0 } })}
              className="text-sm p-0"
            />
          </InputGroup>
        </div>
        <div className="grid grid-cols-2 gap-2">
          <InputGroup>
            ...
            <InputGroupInput
              ...
              onChange={(e) => updateOne({ transform: { width: parseInt(e.target.value) || 0 } })}
              className="text-sm p-0"
            />
          </InputGroup>
          <InputGroup>
            ...
            <InputGroupInput
              ...
              onChange={(e) => updateOne({ transform: { height: parseInt(e.target.value) || 0 } })}
              className="text-sm p-0"
            />
          </InputGroup>
        </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-4">
          ...
          <Slider
            ...
            onValueChange={(v) => updateOne({ transform: { angle: v[0] } })}
            max={360}
            step={1}
            className="flex-1"
          />
          <InputGroup className="w-20">
            <InputGroupInput
              type="number"
              value={Math.round(coreClip.transform?.angle ?? coreClip.angle ?? 0)}
              onChange={(e) => updateOne({ transform: { angle: parseInt(e.target.value) || 0 } })}
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-4">
          ...
          <Slider
            ...
            onValueChange={(v) => updateOne({ transform: { opacity: v[0] / 100 } })}
            max={100}
            step={1}
            className="flex-1"
          />
          <InputGroup className="w-20">
            <InputGroupInput
              ...
              value={Math.round((coreClip.transform?.opacity ?? coreClip.opacity ?? 1) * 100)}
              onChange={(e) =>
                updateOne({ transform: { opacity: (parseInt(e.target.value) || 0) / 100 } })
              }
              className="text-sm p-0 text-center"
            />
            <InputGroupAddon align="inline-end" className="p-0 pr-2">
