...
const SHORTCUTS: ShortcutCategory[] = [
  {
    ...
    items: [
      ...
      { label: 'Paste', keys: ['⌘', 'V'] },
      { label: 'Delete', keys: ['⌫'] },
      { label: 'Undo', keys: ['⌘', 'Z'], disabled: true },
      { label: 'Redo', keys: ['⇧', '⌘', 'Z'], disabled: true },
...
export function ShortcutsModal({ open, onOpenChange }: ShortcutsModalProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="md:max-w-5xl w-full max-w-5xl border bg-zinc-800 p-6 py-8 overflow-hidden">
